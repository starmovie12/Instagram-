export const LogoMark = ({ size = 20, stroke = 1.8 }: { size?: number; stroke?: number }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" aria-hidden>
    <rect x="3" y="3" width="18" height="18" rx="5.5" stroke="#FFFDF6" strokeWidth={stroke} />
    <path d="M10 8.8l5.2 3.2L10 15.2V8.8z" fill="#FFFDF6" />
  </svg>
);

export const DownloadIcon = ({ size = 15, color = "#FFFDF6" }: { size?: number; color?: string }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" aria-hidden>
...
export const StarIcon = ({ size = 12, fill = "#C6A24B" }: { size?: number; fill?: string }) => (
...
export const LinkIcon = ({ size = 17 }: { size?: number }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" aria-hidden>
    <path d="M10 14a5 5 0 007.5.5l2-2a5 5 0 00-7-7l-1.2 1.2" stroke="#B8912F" strokeWidth="1.8" strokeLinecap="round" />
    <path d="M14 10a5 5 0 00-7.5-.5l-2 2a5 5 0 007 7l1.2-1.2" stroke="#B8912F" strokeWidth="1.8" strokeLinecap="round" />
  </svg>
);
