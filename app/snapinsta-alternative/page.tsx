...
export const metadata: Metadata = {
  ...
  description:
    "Looking for a SnapInsta alternative? InstaGrab downloads reels, photos and stories in HD — plus captions, hashtags, 60+ creator tools and Hinglish AI. Free, no login.",
...
export default function Page() {
  return (
    <SimpleToolLanding
      ...
      h1={<>Everything SnapInsta does — <em className="gilded">plus 60 tools it doesn&apos;t</em>.</>}
      ...
      faq={[
        ...
        { q: "What does InstaGrab have that SnapInsta doesn't?", a: "The whole creator workflow: caption + hashtag extraction with every download, Creator Pack ZIP, reel transcripts, AI caption/bio/script generators in Hinglish, engagement calculators, giveaway tools, an image studio — 60+ tools, all free." },
